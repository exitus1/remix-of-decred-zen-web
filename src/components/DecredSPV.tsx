  ...
  return <section className="py-20 px-4 relative">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-primary max-w-3xl mx-auto">Most crypto users unknowingly rely on centralized services for syncing. Decred's syncing process is different.</p>
        </div>
